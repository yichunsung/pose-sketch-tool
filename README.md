...
- AI 辨識提示：左右肢體顏色、身體朝向 F/B/S、頭部方向箭頭、腳尖方向箭頭，以及 `FACE UP`、`FACE DOWN`、`AIRBORNE` 標籤。
...
檔名為 `posesketch-project.stickpose.json`，保留可編輯的所有人物、關節、畫布與背景資料，目前 schema 為 `2`，並能遷移 schema `1` 專案。
